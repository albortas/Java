...
<div class="container">
    ...
    <form action="${urlEditar}" modelAtribute="empleadoForma" method="post">
        ...
        <div class="mb-3">
          <label for="departamento" class="form-label">Deparmento</label>
          <input type="texto" class="form-control" id="departamento" name="departamento" value="${empleado.departamento}">
        </div>
        <div class="mb-3">
