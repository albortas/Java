        ...
        <c:forEach var="empleado" items="${empleados}">
          <tr>
            ...
            <td class="text-center">
              ...
              <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#eliminarModal">Eliminar
              </button>
            </td>            
          </tr>  
        </c:forEach>                  
...
<%@ include file="comunes/eliminar.jsp"%>
