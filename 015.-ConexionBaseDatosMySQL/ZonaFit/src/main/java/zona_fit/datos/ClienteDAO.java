...
public class ClienteDAO implements IClienteDAO{
    ...
    public List<Cliente> listarClientes() {
        ...
        PreparedStatement ps; //Prepara la sentencia sql a ejecutar en la BD
        ResultSet rs; //Recibe la informacion de la consulta
...
/*    public static void main(String[] args) {
        ...
        *//*var cliente1 = new Cliente(2);
        ...
        //Agregar cliente
        *//*var nuevoCliente = new Cliente("Daniel", "Alborta", 300);
        var agregado = clienteDAO.agregarCliente(nuevoCliente);
        if(agregado){
            System.out.println("Cliente agragado: " + nuevoCliente);
        }else{
